...
2.  Convert base by base: ATCG to TAGC for DNA; AUGC to
    UACG for RNA
...
1.  Split a multi-charactered string into a vector of
    alphabets
...
3. Find complementary nucleotides.
...
![Time spent is linear for this function](/img/2018_12_20_running_time.png)
